function darkMode() {
    ...
    document.querySelector(".dark-mode-boton").addEventListener("click", function () {
  ...
  (function (e, n, o) {
    ...
    function A(e) {
      ...
      if ((u && (n = n.baseVal), c._config.enableJSClass)) {
        var t = new RegExp("(^|\\s)" + o + "no-js(\\s|$)");
        n = n.replace(t, "$1" + o + "js$2");
      }
      c._config.enableClasses &&
        ((n += " " + o + e.join(" " + o)),
        u ? (d.className.baseVal = n) : (d.className = n));
    }
    function a(e, n) {
      if ("object" == typeof e) for (var o in e) l(e, o) && a(o, e[o]);
      else {
        var t = (e = e.toLowerCase()).split("."),
          s = c[t[0]];
        if ((2 == t.length && (s = s[t[1]]), void 0 !== s)) return c;
        (n = "function" == typeof n ? n() : n),
          1 == t.length
            ? (c[t[0]] = n)
            : (!c[t[0]] ||
                c[t[0]] instanceof Boolean ||
                (c[t[0]] = new Boolean(c[t[0]])),
              (c[t[0]][t[1]] = n)),
          A([(n && 0 != n ? "" : "no-") + t.join("-")]),
          c._trigger(e, n);
      }
    ...
    !(function () {
      ...
      c.addAsyncTest(function () {
        function e(e, n, o) {
          function t(n) {
            var t = !(!n || "load" !== n.type) && 1 == A.width;
            a(e, "webp" === e && t ? new Boolean(t) : t), o && o(n);
          }
          var A = new Image();
      ...
      (function () {
        ...
        for (var l in i)
          if (i.hasOwnProperty(l)) {
            ...
            for (
              A = t(n.fn, "function") ? n.fn() : n.fn, a = 0;
              a < e.length;
              a++
            )
